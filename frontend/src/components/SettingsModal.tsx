    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70">
            <div className="bg-gray-800 p-6 rounded-lg w-80 shadow-2xl border border-gray-600">
                ...
                <div className="mb-6">
                    <label className="block text-sm text-gray-400 mb-1">Tamaño de Carta en Menu Contextual</label>
                    <div className="flex items-center gap-2">
                ...
                <div className="mb-6">
                    <label className="block text-sm text-gray-400 mb-1">Tamaño de Carta al hacer hover sobre ella (px)</label>
                    <div className="flex items-center gap-2">
                ...
                <div className="mb-6">
                    <label className="block text-sm text-gray-400 mb-1">Tamaño de los botones en el Menu Contextual</label>
                    <div className="flex items-center gap-2">
